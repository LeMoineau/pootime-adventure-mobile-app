import GodPoulpeIcon from "../../../../components/common/icons/entities/god-poulpe/GodPoulpe";
import GodPoulpeFaintedIcon from "../../../../components/common/icons/entities/god-poulpe/GodPoulpeFainted";
import GremlinsIcon from "../../../../components/common/icons/entities/gremlins/Gremlins";
import GremlinsFaintedIcon from "../../../../components/common/icons/entities/gremlins/GremlinsFainted";
import HorrorMaskIcon from "../../../../components/common/icons/entities/horror-mask/HorrorMaskIcon";
import HorrorMaskFaintedIcon from "../../../../components/common/icons/entities/horror-mask/HorrorMaskFainted";
import PingooIcon from "../../../../components/common/icons/entities/pingoo/Pingoo";
import PingooFaintedIcon from "../../../../components/common/icons/entities/pingoo/PingooFainted";
import PoulpeIcon from "../../../../components/common/icons/entities/poulpe/Poulpe";
import PoulpeFaintedIcon from "../../../../components/common/icons/entities/poulpe/PoulpeFainted";
import { CutSheepIcon } from "../../../../components/common/icons/entities/sheep/cutSheep";
import SheepIcon from "../../../../components/common/icons/entities/sheep/sheep";
import TankIcon from "../../../../components/common/icons/entities/tank/Tank";
import TankFaintedIcon from "../../../../components/common/icons/entities/tank/TankFainted";
